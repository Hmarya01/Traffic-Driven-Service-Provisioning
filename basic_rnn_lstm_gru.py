...
Author: Jinsung Yoon, edited to include monte carlo drop out inference by Hafsa Maryam.
"""
...
class GeneralRNN():
  ...
  def _build_model(self, x, y):
    ...
    adam = tf.keras.optimizers.Adam(lr=self.learning_rate, beta_1=0.9, beta_2=0.999, amsgrad=False)
